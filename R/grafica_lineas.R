...
#' @param ext_line_col extra line color
...
grafica_lineas <- function(df,x_axis,y_axis,fill_C,is_date=F,is_num=F,
                           ...
                           add_line=F,ext_line,vline_col="black",ext_line_col="black",
                           size_t=9,size_s=9,
